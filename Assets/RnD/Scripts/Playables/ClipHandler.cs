...
[Serializable]
public class ClipHandle_OTHER_OLD
{
    ...
    public ClipHandle_OTHER_OLD(AnimationClip clip, double scrubTime = 0, float weight = 1f, float speed = 1f)
	{
        this.clip = clip;
